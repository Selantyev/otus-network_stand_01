...
MACHINES = {
  ...
  :office1Router => {
        ...
        :net => [
                   ...
                   {ip: '192.168.2.65', adapter: 4, netmask: "255.255.255.192", virtualbox__intnet: "testsrv-net"},
                   {ip: '192.168.2.129', adapter: 5, netmask: "255.255.255.192", virtualbox__intnet: "mngr-net"},
  ...
  :office2Router => {
        ...
        :net => [
                   ...
                   {ip: '192.168.1.129', adapter: 4, netmask: "255.255.255.192", virtualbox__intnet: "testsrv-net"},
